...
<head>
    ...
    <title>Intellektual sistemlər</title>
...
<div id="wrapper">
    ...
    <%--
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">İnfekion xəstəliklərin ekspert sistemləri</a>
            </div>
            &lt;%&ndash;
                 <!-- /.navbar-header -->
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Infeksion xəstəliklər</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
